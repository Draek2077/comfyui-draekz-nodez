...
export class DraekzCustomElement extends HTMLElement {
    constructor() {
        super(...arguments);
...
DraekzCustomElement.NAME = "draekz-override";
DraekzCustomElement.USE_SHADOW = true;
DraekzCustomElement.TEMPLATES = "";
DraekzCustomElement.CSS = "";
