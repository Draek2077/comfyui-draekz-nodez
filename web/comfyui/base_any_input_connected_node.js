...
import { DraekzBaseVirtualNode } from "./base_node.js";
...
export class BaseAnyInputConnectedNode extends DraekzBaseVirtualNode {
    ...
    clone() {
        ...
        if (!draekz.canvasCurrentlyCopyingToClipboardWithMultipleNodes) {
