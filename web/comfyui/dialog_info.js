import { DraekzDialog } from "../../draekz/common/dialog.js";
import { createElement as $el, empty, appendChildren, getClosestOrSelf, query, queryAll, setAttributes, } from "../../draekz/common/utils_dom.js";
import { logoCivitai, link, pencilColored, diskColored, dotdotdot, } from "../../draekz/common/media/svgs.js";
...
class DraekzInfoDialog extends DraekzDialog {
    constructor(file) {
        const dialogOptions = {
    ...
    async handleEventAction(action, target, e) {
        ...
        if (action === "fetch-civitai") {
            ...
            target === null || target === void 0 ? void 0 : target.classList.toggle("-draekz-is-selected");
    ...
    getInfoContent() {
      ...
      <ul class="draekz-info-area">
        <li title="Type" class="draekz-info-tag -type -type-${(info.type || "").toLowerCase()}"><span>${info.type || ""}</span></li>
        <li title="Base Model" class="draekz-info-tag -basemodel -basemodel-${(info.baseModel || "").toLowerCase()}"><span>${info.baseModel || ""}</span></li>
      ...
      <table class="draekz-info-table">
            ...
            : ((_c = (_b = info.raw) === null || _b === void 0 ? void 0 : _b.civitai) === null || _c === void 0 ? void 0 : _c.error) === "Model not found"
                ...
                : ((_e = (_d = info.raw) === null || _d === void 0 ? void 0 : _d.civitai) === null || _e === void 0 ? void 0 : _e.error)
                    ...
                    : !((_h = info.raw) === null || _h === void 0 ? void 0 : _h.civitai)
                        ? infoTableRow("Civitai", `<button class="draekz-button" data-action="fetch-civitai">Fetch info from civitai</button>`)
                        : ""}
        ...
        ${infoTableRow("Strength Min", (_u = info.strengthMin) !== null && _u !== void 0 ? _u : "", "The recommended minimum strength, In the Lora Loader node, strength will signal when it is below this threshold.", "strengthMin")}
        ${infoTableRow("Strength Max", (_v = info.strengthMax) !== null && _v !== void 0 ? _v : "", "The recommended maximum strength. In the Lora Loader node, strength will signal when it is above this threshold.", "strengthMax")}
        ${""}
      ...
      <ul class="draekz-info-images">${(_y = (_x = info.images) === null || _x === void 0 ? void 0 : _x.map((img) => `
        <li>
                            ...
                            { label: "More Actions", type: "title" },
                            {
                                ...
                                callback: async (e) => {
                                    ...
                                    if ((_a = this.modelInfo) === null || _a === void 0 ? void 0 : _a.file) {
                                        window.open(`draekz/api/loras/info?file=${encodeURIComponent(this.modelInfo.file)}`);
                                    }
                                },
                            },
                            {
...
function getTrainedWordsMarkup(words) {
    ...
    for (const wordData of words || []) {
        markup += `<li title="${wordData.word}" data-word="${wordData.word}" class="draekz-info-trained-words-list-item" data-action="toggle-trained-word">
