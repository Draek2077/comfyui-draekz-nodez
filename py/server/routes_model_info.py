...
@routes.get('/draekz/api/{type}/info')
...
@routes.get('/draekz/api/{type}/info/refresh')
...
@routes.get('/draekz/api/{type}/info/clear')
...
@routes.post('/draekz/api/{type}/info')
...
@routes.get('/draekz/api/{type}/img')
