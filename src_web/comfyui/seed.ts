...
class DraekzSeed extends DraekzBaseServerNode {
  ...
  private logger = draekz.newLogSession(`[Seed]`);
  ...
  /**
   * Intercepts the prompt right before ComfyUI sends it to the server (as fired from draekz) so we
