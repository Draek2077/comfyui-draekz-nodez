...
export type DraekzBaseWidgetBounds = {
...
export type DraekzBaseHitAreas<Keys extends string> = {
  [K in Keys]: DraekzBaseWidgetBounds;
};
 ...
 */
export abstract class DraekzBaseWidget<V extends ICustomWidget["value"]> implements ICustomWidget {
  ...
  // protected hitAreas: {[key: string]: DraekzBaseWidgetBounds} = {};
  protected readonly hitAreas: DraekzBaseHitAreas<any> = {};
  private downedHitAreasForMove: DraekzBaseWidgetBounds[] = [];
  private downedHitAreasForClick: DraekzBaseWidgetBounds[] = [];
 ...
 */
export class DraekzBetterButtonWidget extends DraekzBaseWidget<string> {
 ...
 */
export class DraekzBetterTextWidget extends DraekzBaseWidget<string> {
  value: string;
 ...
 */
type DraekzDividerWidgetOptions = {
  marginTop: number;
  marginBottom: number;
  marginLeft: number;
  marginRight: number;
 ...
 */
export class DraekzDividerWidget extends DraekzBaseWidget<{}> {
  override value = {};
  override options = {serialize: false};
  override readonly type = "custom";

  private readonly widgetOptions: DraekzDividerWidgetOptions = {
    marginTop: 7,
    marginBottom: 7,
    marginLeft: 15,
    marginRight: 15,
  ...
  constructor(widgetOptions?: Partial<DraekzDividerWidgetOptions>) {
    super("divider");
 ...
 */
export type DraekzLabelWidgetOptions = {
 ...
 */
export class DraekzLabelWidget extends DraekzBaseWidget<string> {
  override readonly type = "custom";
  override options = {serialize: false};
  value = "";

  private readonly widgetOptions: DraekzLabelWidgetOptions = {};
  private posY: number = 0;

  constructor(name: string, widgetOptions?: DraekzLabelWidgetOptions) {
    super(name);
    Object.assign(this.widgetOptions, widgetOptions);
  }

  update(widgetOptions: DraekzLabelWidgetOptions) {
    Object.assign(this.widgetOptions, widgetOptions);
  }
...
/** An invisible widget. */
export class DraekzInvisibleWidget<T extends ICustomWidget["value"]> extends DraekzBaseWidget<T> {
  override readonly type = "custom";
